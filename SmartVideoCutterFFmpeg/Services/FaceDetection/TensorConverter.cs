...
public class TensorConverter
{
    ...
    {
        if (img.Channels() != 3)
            throw new ArgumentException($"Expected 3-channel BGR Mat, got {img.Channels()} channels");
        ...
        return new DenseTensor<float>(_floatData, new[] { 1, 3, targetHeight, targetWidth });
    }
